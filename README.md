...
## Features Integrated
- Blue Zones Map: Clickable map with information about each city.
- Survey Section: Assess your city's suitability for the Blue Zones Project.
- Rest Countries API: Display information about countries using a third-party API.
